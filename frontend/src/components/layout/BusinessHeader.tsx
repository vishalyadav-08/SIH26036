      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 h-16">
          ...
          <div className="flex items-center gap-6 min-w-0">
            <Link
              href="/app"
              className="flex items-center gap-2.5 group focus:outline-hidden shrink-0"
            >
            ...
            {/* Desktop Navigation Links: icons only on medium screens, labels from lg */}
            <nav
              ...
              {NAV_ITEMS.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    title={item.label}
                    className={`inline-flex items-center gap-2 px-2.5 lg:px-3 py-2 rounded-lg text-xs font-semibold whitespace-nowrap transition-colors ${
                      active
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            <div
              className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200 min-w-0"
              title={user?.email}
            >
              <div className="w-7 h-7 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center shrink-0">
                <Building2 className="w-3.5 h-3.5" />
              </div>
              <div className="text-left leading-none min-w-0 hidden xl:block">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold whitespace-nowrap text-slate-700 hover:text-rose-700 bg-white hover:bg-rose-50 border border-slate-200 hover:border-rose-200 rounded-xl transition-colors cursor-pointer"
