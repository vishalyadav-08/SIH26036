      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 h-16">
              ...
              {FIELD_NAV_ITEMS.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    title={item.label}
                    className={`inline-flex items-center gap-2 px-2.5 lg:px-3 py-2 rounded-lg text-xs font-semibold whitespace-nowrap transition-colors relative ${
                      active
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            <div
              className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200"
              title={`${user?.email ?? ""} · ${fieldRoleLabel}`}
            >
