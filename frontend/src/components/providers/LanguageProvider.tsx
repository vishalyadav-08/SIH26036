...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "home.workflow.step3.title": "3. Officer Assignment",
    "home.workflow.step3.desc": "Legal Metrology Officer is assigned and inspection schedule is generated.",
    "home.workflow.step4.title": "4. Field Inspection",
    ...
    "home.why.transparentDesc": "Clear audit stages for businesses, inspectors, and departmental supervisors.",
    ...
    "about.platform.p1": "MapanSetu is an integrated digital ecosystem designed to streamline and transparentize the operations of the Department of Legal Metrology. It acts as the central hub connecting businesses, inspectors, and administrative bodies to ensure standard weights and measures compliance across the country.",
    ...
    "about.coord.assign": "Inspector Assignment",
    "about.coord.assignDesc": "Algorithmic and jurisdiction-based routing of verification tasks to authorized officers.",
  ...
  hi: {
    ...
    "home.workflow.step3.title": "3. अधिकारी आवंटन",
    "home.workflow.step3.desc": "विधिक मापविज्ञान अधिकारी आवंटित होता है और निरीक्षण कार्यक्रम निर्धारित होता है।",
    "home.workflow.step4.title": "4. क्षेत्रीय निरीक्षण",
    ...
    "home.why.transparentDesc": "व्यवसायों, निरीक्षकों और विभागीय पर्यवेक्षकों के लिए स्पष्ट ऑडिट चरण।",
    ...
    "about.coord.assign": "निरीक्षक आवंटन",
